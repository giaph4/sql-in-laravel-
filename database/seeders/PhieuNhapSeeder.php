...
class PhieuNhapSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('phieu_nhaps')->insert([
            ...
            ['id' => 2, 'so_phieu_nhap' => 'PN002', 'ngay_nhap' => '2024-09-05', 'id_nha_xuat_ban' => 2],
            ['id' => 3, 'so_phieu_nhap' => 'PN003', 'ngay_nhap' => '2024-09-04', 'id_nha_xuat_ban' => 3],
            ['id' => 4, 'so_phieu_nhap' => 'PN004', 'ngay_nhap' => '2024-09-03', 'id_nha_xuat_ban' => 4],
            ['id' => 5, 'so_phieu_nhap' => 'PN005', 'ngay_nhap' => '2024-09-02', 'id_nha_xuat_ban' => 5],
            ['id' => 6, 'so_phieu_nhap' => 'PN006', 'ngay_nhap' => '2024-09-01', 'id_nha_xuat_ban' => 1],
            ['id' => 7, 'so_phieu_nhap' => 'PN007', 'ngay_nhap' => '2024-08-31', 'id_nha_xuat_ban' => 2],
            ['id' => 8, 'so_phieu_nhap' => 'PN008', 'ngay_nhap' => '2024-08-30', 'id_nha_xuat_ban' => 3],
            ['id' => 9, 'so_phieu_nhap' => 'PN009', 'ngay_nhap' => '2024-08-29', 'id_nha_xuat_ban' => 4],
            ['id' => 10, 'so_phieu_nhap' => 'PN010', 'ngay_nhap' => '2024-08-28', 'id_nha_xuat_ban' => 5],
            ...
            ['id' => 14, 'so_phieu_nhap' => 'PN014', 'ngay_nhap' => '2024-08-24', 'id_nha_xuat_ban' => 4],
            ...
            ['id' => 19, 'so_phieu_nhap' => 'PN019', 'ngay_nhap' => '2024-08-19', 'id_nha_xuat_ban' => 4],
