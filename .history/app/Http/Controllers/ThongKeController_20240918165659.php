...
class ThongKeController extends Controller
{
    ...
    public function thongKeDoanhThuTheLoai()
    {
        $data = TheLoai::join('sachs', 'the_loais.id', 'sachs.id_the_loai')
                ...
                ->select('the_loais.ten_the_loai', DB::raw('SUM(chi_tiet_hoa_dons.so_luong_ban) as tong_so_luong_ban'), DB::raw('SUM(chi_tiet_hoa_dons.thanh_tien) as tong_so_luong_ban') )
    }
}
