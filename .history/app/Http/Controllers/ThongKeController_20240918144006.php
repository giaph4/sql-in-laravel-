...
class ThongKeController extends Controller
{
    ...
    public function thongKeDoanhThuSach()
    {
        $data = Sach::join('chi_tiet_hoa_dons', 'sachs.id', 'chi_tiet_hoa_dons.id_sach')
                    ->select('sachs.ten_sach', 'chi_tiet_hoa_dons.gia_ban', DB::raw('SUM(chi_tiet_hoa_dons.so_luong_ban) as tong_so_luong_ban'), DB::raw('SUM(chi_tiet_hoa_dons.so_luong_ban) as tong_so_luong_ban') )
    }
}
