...
Route::post('/thong-ke/sach/nhap-kho/chi-tiet', [ChiTietThongKeController::class, 'chiTietThongKeSachNhapKho']);
Route::post('/thong-ke/sach/doanh-thu/chi-tiet', [ChiTietThongKeController::class, 'chiTietThongKeDoanhThuSach']);
Route::post('/thong-ke/the-loai/doanh-thu/chi-tiet', [ChiTietThongKeController::class, 'chiTietThongKeDoanhThuTheLoai']);
